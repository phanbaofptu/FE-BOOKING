...
if (isset($_POST['login'])) {
    ...
    if (!$username && !$password) {
        ...
        $query = "SELECT * FROM user WHERE username = '$username' OR username='$username' AND password='$password'";
...
if (isset($_POST['booking'])) {
    ...
    $customer_sql = "INSERT INTO customer (customer_name,contact_no,username,id_card_type_id,id_card_no,address) VALUES ('$name','$contact_no','$username','$id_card_id','$id_card_no','$address')";
...
if (isset($_POST['cutomerDetails'])) {
    ...
    if ($room_id != '') {
        ...
        if ($result) {
            ...
            $response['username'] = $customer_details['username'];
